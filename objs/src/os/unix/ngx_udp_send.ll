; ModuleID = 'src/os/unix/ngx_udp_send.c'
source_filename = "src/os/unix/ngx_udp_send.c"
...
@.str = private unnamed_addr constant [20 x i8] c"sendto() incomplete\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"sendto() failed\00", align 1

; Function Attrs: nounwind
define i32 @ngx_udp_unix_send(%struct.ngx_connection_s* %c, i8* %buf, i32 %size) #0 !dbg !10 {
entry:
...
for.cond:                                         ; preds = %if.end18, %entry
  ...
  %9 = load %struct.ngx_connection_s*, %struct.ngx_connection_s** %c.addr, align 4, !dbg !416, !tbaa !382
  %sockaddr = getelementptr inbounds %struct.ngx_connection_s, %struct.ngx_connection_s* %9, i32 0, i32 13, !dbg !417
  %10 = load %struct.sockaddr*, %struct.sockaddr** %sockaddr, align 4, !dbg !417, !tbaa !418
  %11 = load %struct.ngx_connection_s*, %struct.ngx_connection_s** %c.addr, align 4, !dbg !419, !tbaa !382
  %socklen = getelementptr inbounds %struct.ngx_connection_s, %struct.ngx_connection_s* %11, i32 0, i32 14, !dbg !420
  %12 = load i32, i32* %socklen, align 4, !dbg !420, !tbaa !421
  %call = call i32 @sendto(i32 %6, i8* %7, i32 %8, i32 0, %struct.sockaddr* %10, i32 %12), !dbg !422
  store i32 %call, i32* %n, align 4, !dbg !423, !tbaa !389
  %13 = load i32, i32* %n, align 4, !dbg !424, !tbaa !389
  %cmp = icmp sge i32 %13, 0, !dbg !426
  br i1 %cmp, label %if.then, label %if.end4, !dbg !427

if.then:                                          ; preds = %for.cond
  %14 = load i32, i32* %n, align 4, !dbg !428, !tbaa !389
  %15 = load i32, i32* %size.addr, align 4, !dbg !431, !tbaa !389
  %cmp1 = icmp ne i32 %14, %15, !dbg !432
  br i1 %cmp1, label %if.then2, label %if.end, !dbg !433

if.then2:                                         ; preds = %if.then
  %16 = load %struct.ngx_event_s*, %struct.ngx_event_s** %wev, align 4, !dbg !434, !tbaa !382
  %error = getelementptr inbounds %struct.ngx_event_s, %struct.ngx_event_s* %16, i32 0, i32 1, !dbg !436
  %17 = bitcast i24* %error to i32*, !dbg !436
  %bf.load = load i32, i32* %17, align 4, !dbg !437
  %bf.clear = and i32 %bf.load, -513, !dbg !437
  %bf.set = or i32 %bf.clear, 512, !dbg !437
  store i32 %bf.set, i32* %17, align 4, !dbg !437
  %18 = load %struct.ngx_connection_s*, %struct.ngx_connection_s** %c.addr, align 4, !dbg !438, !tbaa !382
  %call3 = call i32 @ngx_connection_error(%struct.ngx_connection_s* %18, i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0)), !dbg !439
  store i32 -1, i32* %retval, align 4, !dbg !440
  store i32 1, i32* %cleanup.dest.slot, align 4
  br label %cleanup, !dbg !440

if.end:                                           ; preds = %if.then
  %19 = load i32, i32* %n, align 4, !dbg !441, !tbaa !389
  %20 = load %struct.ngx_connection_s*, %struct.ngx_connection_s** %c.addr, align 4, !dbg !442, !tbaa !382
  %sent = getelementptr inbounds %struct.ngx_connection_s, %struct.ngx_connection_s* %20, i32 0, i32 9, !dbg !443
  %21 = load i32, i32* %sent, align 4, !dbg !444, !tbaa !445
  %add = add nsw i32 %21, %19, !dbg !444
  store i32 %add, i32* %sent, align 4, !dbg !444, !tbaa !445
  %22 = load i32, i32* %n, align 4, !dbg !446, !tbaa !389
  store i32 %22, i32* %retval, align 4, !dbg !447
  store i32 1, i32* %cleanup.dest.slot, align 4
  br label %cleanup, !dbg !447

if.end4:                                          ; preds = %for.cond
  %call5 = call i32* @__errno_location(), !dbg !448
  %23 = load i32, i32* %call5, align 4, !dbg !448, !tbaa !389
  store i32 %23, i32* %err, align 4, !dbg !449, !tbaa !389
  %24 = load i32, i32* %err, align 4, !dbg !450, !tbaa !389
  %cmp6 = icmp eq i32 %24, 11, !dbg !452
  br i1 %cmp6, label %if.then7, label %if.end10, !dbg !453

if.then7:                                         ; preds = %if.end4
  %25 = load %struct.ngx_event_s*, %struct.ngx_event_s** %wev, align 4, !dbg !454, !tbaa !382
  %ready = getelementptr inbounds %struct.ngx_event_s, %struct.ngx_event_s* %25, i32 0, i32 1, !dbg !456
  %26 = bitcast i24* %ready to i32*, !dbg !456
  %bf.load8 = load i32, i32* %26, align 4, !dbg !457
  %bf.clear9 = and i32 %bf.load8, -33, !dbg !457
  store i32 %bf.clear9, i32* %26, align 4, !dbg !457
  store i32 -2, i32* %retval, align 4, !dbg !458
  store i32 1, i32* %cleanup.dest.slot, align 4
  br label %cleanup, !dbg !458

if.end10:                                         ; preds = %if.end4
  %27 = load i32, i32* %err, align 4, !dbg !459, !tbaa !389
  %cmp11 = icmp ne i32 %27, 4, !dbg !461
  br i1 %cmp11, label %if.then12, label %if.end18, !dbg !462

if.then12:                                        ; preds = %if.end10
  %28 = load %struct.ngx_event_s*, %struct.ngx_event_s** %wev, align 4, !dbg !463, !tbaa !382
  %error13 = getelementptr inbounds %struct.ngx_event_s, %struct.ngx_event_s* %28, i32 0, i32 1, !dbg !465
  %29 = bitcast i24* %error13 to i32*, !dbg !465
  %bf.load14 = load i32, i32* %29, align 4, !dbg !466
  %bf.clear15 = and i32 %bf.load14, -513, !dbg !466
  %bf.set16 = or i32 %bf.clear15, 512, !dbg !466
  store i32 %bf.set16, i32* %29, align 4, !dbg !466
  %30 = load %struct.ngx_connection_s*, %struct.ngx_connection_s** %c.addr, align 4, !dbg !467, !tbaa !382
  %31 = load i32, i32* %err, align 4, !dbg !468, !tbaa !389
  %call17 = call i32 @ngx_connection_error(%struct.ngx_connection_s* %30, i32 %31, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0)), !dbg !469
  store i32 -1, i32* %retval, align 4, !dbg !470
  store i32 1, i32* %cleanup.dest.slot, align 4
...
cleanup:                                          ; preds = %if.then12, %if.then7, %if.end, %if.then2
  %32 = bitcast %struct.ngx_event_s** %wev to i8*, !dbg !475
  call void @llvm.lifetime.end(i64 4, i8* %32) #4, !dbg !475
  %33 = bitcast i32* %err to i8*, !dbg !475
  call void @llvm.lifetime.end(i64 4, i8* %33) #4, !dbg !475
  %34 = bitcast i32* %n to i8*, !dbg !475
  call void @llvm.lifetime.end(i64 4, i8* %34) #4, !dbg !475
  %35 = load i32, i32* %retval, align 4, !dbg !475
  ret i32 %35, !dbg !475
}
...
declare i32 @sendto(i32, i8*, i32, i32, %struct.sockaddr*, i32) #3
...
!1 = !DIFile(filename: "src/os/unix/ngx_udp_send.c", directory: "/home/sam/Projects/nginx-1.12.2")
!2 = !{}
!3 = !{!4}
...
!10 = distinct !DISubprogram(name: "ngx_udp_unix_send", scope: !1, file: !1, line: 14, type: !11, isLocal: false, isDefinition: true, scopeLine: 15, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !373)
...
!381 = !DILocalVariable(name: "wev", scope: !10, file: !1, line: 18, type: !24)
!382 = !{!383, !383, i64 0}
!383 = !{!"any pointer", !384, i64 0}
!384 = !{!"omnipotent char", !385, i64 0}
!385 = !{!"Simple C/C++ TBAA"}
!386 = !DIExpression()
!387 = !DILocation(line: 14, column: 37, scope: !10)
!388 = !DILocation(line: 14, column: 48, scope: !10)
!389 = !{!390, !390, i64 0}
!390 = !{!"int", !384, i64 0}
!391 = !DILocation(line: 14, column: 60, scope: !10)
...
!407 = !DILocation(line: 22, column: 5, scope: !10)
!408 = !DILocation(line: 23, column: 20, scope: !409)
!409 = distinct !DILexicalBlock(scope: !410, file: !1, line: 22, column: 16)
!410 = distinct !DILexicalBlock(scope: !411, file: !1, line: 22, column: 5)
!411 = distinct !DILexicalBlock(scope: !10, file: !1, line: 22, column: 5)
!412 = !DILocation(line: 23, column: 23, scope: !409)
!413 = !{!401, !390, i64 12}
!414 = !DILocation(line: 23, column: 27, scope: !409)
!415 = !DILocation(line: 23, column: 32, scope: !409)
!416 = !DILocation(line: 23, column: 41, scope: !409)
!417 = !DILocation(line: 23, column: 44, scope: !409)
!418 = !{!401, !383, i64 52}
!419 = !DILocation(line: 23, column: 54, scope: !409)
!420 = !DILocation(line: 23, column: 57, scope: !409)
!421 = !{!401, !390, i64 56}
!422 = !DILocation(line: 23, column: 13, scope: !409)
!423 = !DILocation(line: 23, column: 11, scope: !409)
!424 = !DILocation(line: 29, column: 13, scope: !425)
!425 = distinct !DILexicalBlock(scope: !409, file: !1, line: 29, column: 13)
!426 = !DILocation(line: 29, column: 15, scope: !425)
!427 = !DILocation(line: 29, column: 13, scope: !409)
!428 = !DILocation(line: 30, column: 26, scope: !429)
!429 = distinct !DILexicalBlock(scope: !430, file: !1, line: 30, column: 17)
!430 = distinct !DILexicalBlock(scope: !425, file: !1, line: 29, column: 21)
!431 = !DILocation(line: 30, column: 31, scope: !429)
!432 = !DILocation(line: 30, column: 28, scope: !429)
!433 = !DILocation(line: 30, column: 17, scope: !430)
!434 = !DILocation(line: 31, column: 17, scope: !435)
!435 = distinct !DILexicalBlock(scope: !429, file: !1, line: 30, column: 37)
!436 = !DILocation(line: 31, column: 22, scope: !435)
!437 = !DILocation(line: 31, column: 28, scope: !435)
!438 = !DILocation(line: 32, column: 45, scope: !435)
!439 = !DILocation(line: 32, column: 24, scope: !435)
!440 = !DILocation(line: 33, column: 17, scope: !435)
!441 = !DILocation(line: 36, column: 24, scope: !430)
!442 = !DILocation(line: 36, column: 13, scope: !430)
!443 = !DILocation(line: 36, column: 16, scope: !430)
!444 = !DILocation(line: 36, column: 21, scope: !430)
!445 = !{!401, !390, i64 36}
!446 = !DILocation(line: 38, column: 20, scope: !430)
!447 = !DILocation(line: 38, column: 13, scope: !430)
!448 = !DILocation(line: 41, column: 15, scope: !409)
!449 = !DILocation(line: 41, column: 13, scope: !409)
!450 = !DILocation(line: 43, column: 13, scope: !451)
!451 = distinct !DILexicalBlock(scope: !409, file: !1, line: 43, column: 13)
!452 = !DILocation(line: 43, column: 17, scope: !451)
!453 = !DILocation(line: 43, column: 13, scope: !409)
!454 = !DILocation(line: 44, column: 13, scope: !455)
!455 = distinct !DILexicalBlock(scope: !451, file: !1, line: 43, column: 32)
!456 = !DILocation(line: 44, column: 18, scope: !455)
!457 = !DILocation(line: 44, column: 24, scope: !455)
!458 = !DILocation(line: 47, column: 13, scope: !455)
!459 = !DILocation(line: 50, column: 13, scope: !460)
!460 = distinct !DILexicalBlock(scope: !409, file: !1, line: 50, column: 13)
!461 = !DILocation(line: 50, column: 17, scope: !460)
!462 = !DILocation(line: 50, column: 13, scope: !409)
!463 = !DILocation(line: 51, column: 13, scope: !464)
!464 = distinct !DILexicalBlock(scope: !460, file: !1, line: 50, column: 31)
!465 = !DILocation(line: 51, column: 18, scope: !464)
!466 = !DILocation(line: 51, column: 24, scope: !464)
!467 = !DILocation(line: 52, column: 41, scope: !464)
!468 = !DILocation(line: 52, column: 44, scope: !464)
!469 = !DILocation(line: 52, column: 20, scope: !464)
!470 = !DILocation(line: 53, column: 13, scope: !464)
!471 = !DILocation(line: 22, column: 5, scope: !410)
!472 = distinct !{!472, !473, !474}
!473 = !DILocation(line: 22, column: 5, scope: !411)
!474 = !DILocation(line: 55, column: 5, scope: !411)
!475 = !DILocation(line: 56, column: 1, scope: !10)
