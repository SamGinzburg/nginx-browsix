; ModuleID = 'src/os/unix/ngx_setaffinity.c'
source_filename = "src/os/unix/ngx_setaffinity.c"
...
!1 = !DIFile(filename: "src/os/unix/ngx_setaffinity.c", directory: "/home/sam/Projects/nginx-1.12.2")
!2 = !{}
